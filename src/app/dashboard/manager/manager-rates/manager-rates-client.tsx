...
import { ManagerRateForm } from "./manager-rate-form";
...
interface ManagerRatesClientProps {
  sheets: RateSheetRow[];
  principals: PrincipalOption[];
  carriers: CarrierOption[];
}

export function ManagerRatesClient({
  sheets,
  principals,
  carriers,
}: ManagerRatesClientProps) {
  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Set the available revenue you grant each of your managers per
            install. Your managers pay their reps out of this amount.
          </p>
        </div>
      ...
      <DataTable
        ...
        pagination
        pageSize={20}
        emptyMessage="No manager rates found. Add one to get started."
      />
